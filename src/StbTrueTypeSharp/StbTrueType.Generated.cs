...
namespace StbTrueTypeSharp
{
	unsafe partial class StbTrueType
	{
		...
		{
			int count = 0; int start = 0; int offsize = 0;
			start = (int)(b->cursor);
		...
		{
			int v = 0; int b0 = (int)(stbtt__buf_peek8(b));
			if ((b0) == (30))
			{
		...
		public static stbtt__buf stbtt__dict_get(stbtt__buf* b, int key)
		{
			...
			{
				int start = (int)(b->cursor); int end = 0; int op = 0; while ((stbtt__buf_peek8(b)) >= (28)) { stbtt__cff_skip_operand(b); }
				end = (int)(b->cursor); op = (int)(stbtt__buf_get8(b)); if ((op) == (12)) op = (int)(stbtt__buf_get8(b) | 0x100); if ((op) == (key)) return (stbtt__buf)(stbtt__buf_range(b, (int)(start), (int)(end - start)));
			}
		...
		{
			int count = 0; int offsize = 0; int start = 0; int end = 0;
			stbtt__buf_seek(&b, (int)(0));
			count = (int)(stbtt__buf_get((&b), (int)(2)));
		...
		public static int stbtt__get_svg(stbtt_fontinfo info)
		{
			...
			if ((info.svg) < (0))
			{
				t = (uint)(stbtt__find_table(info.data, (uint)(info.fontstart), "SVG ")); if ((t) != 0)
				{
					uint offset = (uint)(ttULONG(info.data + t + 2)); info.svg = (int)(t + offset);
				}
				else
				{
					info.svg = (int)(0);
			...
			for (i = (int)(0); (i) < (numTables); ++i)
			{
				uint encoding_record = (uint)(cmap + 4 + 8 * i); switch (ttUSHORT(data + encoding_record))
				{
					case STBTT_PLATFORM_ID_MICROSOFT:
						...
						break;
					case STBTT_PLATFORM_ID_UNICODE: info.index_map = (int)(cmap + ttULONG(data + encoding_record + 4)); break;
				}
			}
		...
		public static int stbtt_FindGlyphIndex(stbtt_fontinfo info, int unicode_codepoint)
		{
			...
			else if ((format) == (4))
			{
				...
				{
					ushort end = 0; searchRange >>= 1; end = (ushort)(ttUSHORT(data + search + searchRange * 2)); if ((unicode_codepoint) > (end)) search += (uint)(searchRange * 2); --entrySelector;
				}
				search += (uint)(2);
				{
					ushort offset = 0; ushort start = 0; ushort item = (ushort)((search - endCount) >> 1); start = (ushort)(ttUSHORT(data + index_map + 14 + segcount * 2 + 2 + 2 * item)); if ((unicode_codepoint) < (start)) return (int)(0); offset = (ushort)(ttUSHORT(data + index_map + 14 + segcount * 6 + 2 + 2 * item)); if ((offset) == (0)) return (int)((ushort)(unicode_codepoint + ttSHORT(data + index_map + 14 + segcount * 4 + 2 + 2 * item))); return (int)(ttUSHORT(data + offset + (unicode_codepoint - start) * 2 + index_map + 14 + segcount * 6 + 2 + 2 * item));
				}
			}
			else if (((format) == (12)) || ((format) == (13)))
			{
				...
				{
					int mid = (int)(low + ((high - low) >> 1)); uint start_char = (uint)(ttULONG(data + index_map + 16 + mid * 12)); uint end_char = (uint)(ttULONG(data + index_map + 16 + mid * 12 + 4)); if (((uint)(unicode_codepoint)) < (start_char)) high = (int)(mid);
		...
		public static int stbtt__GetGlyphShapeTT(stbtt_fontinfo info, int glyph_index, stbtt_vertex** pvertices)
		{
			...
			*pvertices = (null);
			...
			{
				byte flags = (byte)(0); byte flagcount = 0; int ins = 0; int i = 0; int j = (int)(0); int m = 0; int n = 0; int next_move = 0; int was_off = (int)(0); int off = 0; int start_off = (int)(0); int x = 0; int y = 0; int cx = 0; int cy = 0; int sx = 0; int sy = 0; int scx = 0; int scy = 0; byte* points; endPtsOfContours = (data + g + 10); ins = (int)(ttUSHORT(data + g + 10 + numberOfContours * 2)); points = data + g + 10 + numberOfContours * 2 + 2 + ins; n = (int)(1 + ttUSHORT(endPtsOfContours + numberOfContours * 2 - 2)); m = (int)(n + 2 * numberOfContours); vertices = (stbtt_vertex*)(CRuntime.malloc((ulong)(m * sizeof(stbtt_vertex)))); if ((vertices) == (null)) return (int)(0); next_move = (int)(0); flagcount = (byte)(0); off = (int)(m - n); for (i = (int)(0); (i) < (n); ++i)
				{
					if ((flagcount) == (0))
					{
						flags = (byte)(*points++); if ((flags & 8) != 0) flagcount = (byte)(*points++);
					}
					else --flagcount; vertices[off + i].type = (byte)(flags);
				}
				x = (int)(0); for (i = (int)(0); (i) < (n); ++i)
				{
				...
				num_vertices = (int)(0); sx = (int)(sy = (int)(cx = (int)(cy = (int)(scx = (int)(scy = (int)(0)))))); for (i = (int)(0); (i) < (n); ++i)
				{
					flags = (byte)(vertices[off + i].type); x = (int)(vertices[off + i].x); y = (int)(vertices[off + i].y); if ((next_move) == (i))
					{
						if (i != 0) num_vertices = (int)(stbtt__close_shape(vertices, (int)(num_vertices), (int)(was_off), (int)(start_off), (int)(sx), (int)(sy), (int)(scx), (int)(scy), (int)(cx), (int)(cy))); start_off = ((flags & 1) != 0 ? 0 : 1); if ((start_off) != 0)
						{
			...
			else if ((numberOfContours) < (0))
			{
				int more = (int)(1); byte* comp = data + g + 10; num_vertices = (int)(0); vertices = null; while ((more) != 0)
				{
					...
					m = ((float)(CRuntime.sqrt((double)(mtx[0] * mtx[0] + mtx[1] * mtx[1])))); n = ((float)(CRuntime.sqrt((double)(mtx[2] * mtx[2] + mtx[3] * mtx[3])))); comp_num_verts = (int)(stbtt_GetGlyphShape(info, (int)(gidx), &comp_verts)); if ((comp_num_verts) > (0))
					{
						...
						{
							stbtt_vertex* v = &comp_verts[i]; short x = 0; short y = 0; x = (short)(v->x); y = (short)(v->y); v->x = ((short)(m * (mtx[0] * x + mtx[2] * y + mtx[4]))); v->y = ((short)(n * (mtx[1] * x + mtx[3] * y + mtx[5]))); x = (short)(v->cx); y = (short)(v->cy); v->cx = ((short)(m * (mtx[0] * x + mtx[2] * y + mtx[4]))); v->cy = ((short)(n * (mtx[1] * x + mtx[3] * y + mtx[5])));
						}
						tmp = (stbtt_vertex*)(CRuntime.malloc((ulong)((num_vertices + comp_num_verts) * sizeof(stbtt_vertex)))); if (tmp == null)
						{
		...
		public static stbtt__buf stbtt__cid_get_glyph_subrs(stbtt_fontinfo info, int glyph_index)
		{
			...
			int nranges = 0; int start = 0; int end = 0; int v = 0; int fmt = 0; int fdselector = (int)(-1); int i = 0;
		...
		{
			int in_header = (int)(1); int maskbits = (int)(0); int subr_stack_height = (int)(0); int sp = (int)(0); int v = 0; int i = 0; int b0 = 0;
			int has_subrs = (int)(0); int clear_stack = 0;
			...
			while ((b.cursor) < (b.size))
			{
				...
				{
					case 0x13: case 0x14: if ((in_header) != 0) maskbits += (int)(sp / 2); in_header = (int)(0); stbtt__buf_skip(&b, (int)((maskbits + 7) / 8)); break;
					case 0x01: case 0x03: case 0x12: case 0x17: maskbits += (int)(sp / 2); break;
					case 0x15: in_header = (int)(0); if ((sp) < (2)) return (int)(0); stbtt__csctx_rmove_to(c, (float)(s[sp - 2]), (float)(s[sp - 1])); break;
					case 0x04: in_header = (int)(0); if ((sp) < (1)) return (int)(0); stbtt__csctx_rmove_to(c, (float)(0), (float)(s[sp - 1])); break;
					case 0x16: in_header = (int)(0); if ((sp) < (1)) return (int)(0); stbtt__csctx_rmove_to(c, (float)(s[sp - 1]), (float)(0)); break;
					case 0x05: if ((sp) < (2)) return (int)(0); for (; (i + 1) < (sp); i += (int)(2)) { stbtt__csctx_rline_to(c, (float)(s[i]), (float)(s[i + 1])); } break;
					case 0x07:
					case 0x06:
						if ((sp) < (1)) return (int)(0); int goto_vlineto = (int)((b0) == (0x07) ? 1 : 0); for (; ; )
						{
							if ((goto_vlineto) == (0))
							{
								if ((i) >= (sp)) break; stbtt__csctx_rline_to(c, (float)(s[i]), (float)(0)); i++;
							}
							goto_vlineto = (int)(0); if ((i) >= (sp)) break; stbtt__csctx_rline_to(c, (float)(0), (float)(s[i])); i++;
						}
						break;
					case 0x1F:
					case 0x1E:
						if ((sp) < (4)) return (int)(0); int goto_hvcurveto = (int)((b0) == (0x1F) ? 1 : 0); for (; ; )
						{
							if ((goto_hvcurveto) == (0))
							{
								if ((i + 3) >= (sp)) break; stbtt__csctx_rccurve_to(c, (float)(0), (float)(s[i]), (float)(s[i + 1]), (float)(s[i + 2]), (float)(s[i + 3]), (float)(((sp - i) == (5)) ? s[i + 4] : 0.0f)); i += (int)(4);
							}
							goto_hvcurveto = (int)(0); if ((i + 3) >= (sp)) break; stbtt__csctx_rccurve_to(c, (float)(s[i]), (float)(0), (float)(s[i + 1]), (float)(s[i + 2]), (float)(((sp - i) == (5)) ? s[i + 4] : 0.0f), (float)(s[i + 3])); i += (int)(4);
						}
						break;
					case 0x08: if ((sp) < (6)) return (int)(0); for (; (i + 5) < (sp); i += (int)(6)) { stbtt__csctx_rccurve_to(c, (float)(s[i]), (float)(s[i + 1]), (float)(s[i + 2]), (float)(s[i + 3]), (float)(s[i + 4]), (float)(s[i + 5])); } break;
					case 0x18: if ((sp) < (8)) return (int)(0); for (; (i + 5) < (sp - 2); i += (int)(6)) { stbtt__csctx_rccurve_to(c, (float)(s[i]), (float)(s[i + 1]), (float)(s[i + 2]), (float)(s[i + 3]), (float)(s[i + 4]), (float)(s[i + 5])); } if ((i + 1) >= (sp)) return (int)(0); stbtt__csctx_rline_to(c, (float)(s[i]), (float)(s[i + 1])); break;
					case 0x19: if ((sp) < (8)) return (int)(0); for (; (i + 1) < (sp - 6); i += (int)(2)) { stbtt__csctx_rline_to(c, (float)(s[i]), (float)(s[i + 1])); } if ((i + 5) >= (sp)) return (int)(0); stbtt__csctx_rccurve_to(c, (float)(s[i]), (float)(s[i + 1]), (float)(s[i + 2]), (float)(s[i + 3]), (float)(s[i + 4]), (float)(s[i + 5])); break;
					case 0x1A:
					case 0x1B:
						if ((sp) < (4)) return (int)(0); f = (float)(0.0); if ((sp & 1) != 0)
						{
							f = (float)(s[i]); i++;
						}
						for (; (i + 3) < (sp); i += (int)(4))
						{
							if ((b0) == (0x1B)) stbtt__csctx_rccurve_to(c, (float)(s[i]), (float)(f), (float)(s[i + 1]), (float)(s[i + 2]), (float)(s[i + 3]), (float)(0.0)); else stbtt__csctx_rccurve_to(c, (float)(f), (float)(s[i]), (float)(s[i + 1]), (float)(s[i + 2]), (float)(0.0), (float)(s[i + 3])); f = (float)(0.0);
						}
						break;
					case 0x0A:
					case 0x1D:
						...
						if ((sp) < (1)) return (int)(0); v = ((int)(s[--sp])); if ((subr_stack_height) >= (10)) return (int)(0); subr_stack[subr_stack_height++] = (stbtt__buf)(b); b = (stbtt__buf)(stbtt__get_subr((stbtt__buf)((b0) == (0x0A) ? subrs : info.gsubrs), (int)(v))); if ((b.size) == (0)) return (int)(0); b.cursor = (int)(0); clear_stack = (int)(0); break;
					case 0x0B: if (subr_stack_height <= 0) return (int)(0); b = (stbtt__buf)(subr_stack[--subr_stack_height]); clear_stack = (int)(0); break;
					case 0x0E: stbtt__csctx_close_shape(c); return (int)(1);
					case 0x0C:
					{
						float dx1 = 0; float dx2 = 0; float dx3 = 0; float dx4 = 0; float dx5 = 0; float dx6 = 0; float dy1 = 0; float dy2 = 0; float dy3 = 0; float dy4 = 0; float dy5 = 0; float dy6 = 0; float dx = 0; float dy = 0; int b1 = (int)(stbtt__buf_get8(&b)); switch (b1)
						{
							case 0x22: if ((sp) < (7)) return (int)(0); dx1 = (float)(s[0]); dx2 = (float)(s[1]); dy2 = (float)(s[2]); dx3 = (float)(s[3]); dx4 = (float)(s[4]); dx5 = (float)(s[5]); dx6 = (float)(s[6]); stbtt__csctx_rccurve_to(c, (float)(dx1), (float)(0), (float)(dx2), (float)(dy2), (float)(dx3), (float)(0)); stbtt__csctx_rccurve_to(c, (float)(dx4), (float)(0), (float)(dx5), (float)(-dy2), (float)(dx6), (float)(0)); break;
							case 0x23: if ((sp) < (13)) return (int)(0); dx1 = (float)(s[0]); dy1 = (float)(s[1]); dx2 = (float)(s[2]); dy2 = (float)(s[3]); dx3 = (float)(s[4]); dy3 = (float)(s[5]); dx4 = (float)(s[6]); dy4 = (float)(s[7]); dx5 = (float)(s[8]); dy5 = (float)(s[9]); dx6 = (float)(s[10]); dy6 = (float)(s[11]); stbtt__csctx_rccurve_to(c, (float)(dx1), (float)(dy1), (float)(dx2), (float)(dy2), (float)(dx3), (float)(dy3)); stbtt__csctx_rccurve_to(c, (float)(dx4), (float)(dy4), (float)(dx5), (float)(dy5), (float)(dx6), (float)(dy6)); break;
							case 0x24: if ((sp) < (9)) return (int)(0); dx1 = (float)(s[0]); dy1 = (float)(s[1]); dx2 = (float)(s[2]); dy2 = (float)(s[3]); dx3 = (float)(s[4]); dx4 = (float)(s[5]); dx5 = (float)(s[6]); dy5 = (float)(s[7]); dx6 = (float)(s[8]); stbtt__csctx_rccurve_to(c, (float)(dx1), (float)(dy1), (float)(dx2), (float)(dy2), (float)(dx3), (float)(0)); stbtt__csctx_rccurve_to(c, (float)(dx4), (float)(0), (float)(dx5), (float)(dy5), (float)(dx6), (float)(-(dy1 + dy2 + dy5))); break;
					...
					break;
					default:
						if (((b0 != 255) && (b0 != 28)) && (((b0) < (32)) || ((b0) > (254)))) return (int)(0); if ((b0) == (255))
						{
		...
		public static int stbtt_GetKerningTable(stbtt_fontinfo info, stbtt_kerningentry* table, int table_length)
		{
			...
			if ((table_length) < (length)) length = (int)(table_length);
			for (k = (int)(0); (k) < (length); k++)
			{
				table[k].glyph1 = (int)(ttUSHORT(data + 18 + (k * 6))); table[k].glyph2 = (int)(ttUSHORT(data + 20 + (k * 6))); table[k].advance = (int)(ttSHORT(data + 22 + (k * 6)));
			}
			return (int)(length);
		}
		...
		public static int stbtt__GetCoverageIndex(byte* coverageTable, int glyph)
		{
			...
			switch (coverageFormat)
			{
				case 1:
				{
					ushort glyphCount = (ushort)(ttUSHORT(coverageTable + 2)); int l = (int)(0); int r = (int)(glyphCount - 1); int m = 0; int straw = 0; int needle = (int)(glyph); while (l <= r)
					{
						byte* glyphArray = coverageTable + 4; ushort glyphID = 0; m = (int)((l + r) >> 1); glyphID = (ushort)(ttUSHORT(glyphArray + 2 * m)); straw = (int)(glyphID); if ((needle) < (straw)) r = (int)(m - 1);
				...
				case 2:
				{
					ushort rangeCount = (ushort)(ttUSHORT(coverageTable + 2)); byte* rangeArray = coverageTable + 4; int l = (int)(0); int r = (int)(rangeCount - 1); int m = 0; int strawStart = 0; int strawEnd = 0; int needle = (int)(glyph); while (l <= r)
					{
						byte* rangeRecord; m = (int)((l + r) >> 1); rangeRecord = rangeArray + 6 * m; strawStart = (int)(ttUSHORT(rangeRecord)); strawEnd = (int)(ttUSHORT(rangeRecord + 2)); if ((needle) < (strawStart)) r = (int)(m - 1);
						else if ((needle) > (strawEnd)) l = (int)(m + 1);
						else
						{
							ushort startCoverageIndex = (ushort)(ttUSHORT(rangeRecord + 4)); return (int)(startCoverageIndex + glyph - strawStart);
						}
					}
				}
				break;
		...
		public static int stbtt__GetGlyphClass(byte* classDefTable, int glyph)
		{
			...
			switch (classDefFormat)
			{
				case 1:
				{
					ushort startGlyphID = (ushort)(ttUSHORT(classDefTable + 2)); ushort glyphCount = (ushort)(ttUSHORT(classDefTable + 4)); byte* classDef1ValueArray = classDefTable + 6; if (((glyph) >= (startGlyphID)) && ((glyph) < (startGlyphID + glyphCount))) return (int)(ttUSHORT(classDef1ValueArray + 2 * (glyph - startGlyphID))); classDefTable = classDef1ValueArray + 2 * glyphCount;
				}
				break;
				case 2:
				{
					ushort classRangeCount = (ushort)(ttUSHORT(classDefTable + 2)); byte* classRangeRecords = classDefTable + 4; int l = (int)(0); int r = (int)(classRangeCount - 1); int m = 0; int strawStart = 0; int strawEnd = 0; int needle = (int)(glyph); while (l <= r)
					{
						byte* classRangeRecord; m = (int)((l + r) >> 1); classRangeRecord = classRangeRecords + 6 * m; strawStart = (int)(ttUSHORT(classRangeRecord)); strawEnd = (int)(ttUSHORT(classRangeRecord + 2)); if ((needle) < (strawStart)) r = (int)(m - 1); else if ((needle) > (strawEnd)) l = (int)(m + 1); else return (int)(ttUSHORT(classRangeRecord + 4));
					}
		...
		public static int stbtt__GetGlyphGPOSInfoAdvance(stbtt_fontinfo info, int glyph1, int glyph2)
		{
			...
			{
				ushort lookupOffset = (ushort)(ttUSHORT(lookupList + 2 + 2 * i)); byte* lookupTable = lookupList + lookupOffset; ushort lookupType = (ushort)(ttUSHORT(lookupTable)); ushort subTableCount = (ushort)(ttUSHORT(lookupTable + 4)); byte* subTableOffsets = lookupTable + 6; switch (lookupType)
				{
					case 2:
					{
						int sti = 0; for (sti = (int)(0); (sti) < (subTableCount); sti++)
						{
							ushort subtableOffset = (ushort)(ttUSHORT(subTableOffsets + 2 * sti)); byte* table = lookupTable + subtableOffset; ushort posFormat = (ushort)(ttUSHORT(table)); ushort coverageOffset = (ushort)(ttUSHORT(table + 2)); int coverageIndex = (int)(stbtt__GetCoverageIndex(table + coverageOffset, (int)(glyph1))); if ((coverageIndex) == (-1)) continue; switch (posFormat)
							{
								case 1:
								{
									int l = 0; int r = 0; int m = 0; int straw = 0; int needle = 0; ushort valueFormat1 = (ushort)(ttUSHORT(table + 4)); ushort valueFormat2 = (ushort)(ttUSHORT(table + 6)); int valueRecordPairSizeInBytes = (int)(2); ushort pairSetCount = (ushort)(ttUSHORT(table + 8)); ushort pairPosOffset = (ushort)(ttUSHORT(table + 10 + 2 * coverageIndex)); byte* pairValueTable = table + pairPosOffset; ushort pairValueCount = (ushort)(ttUSHORT(pairValueTable)); byte* pairValueArray = pairValueTable + 2; if (valueFormat1 != 4) return (int)(0); if (valueFormat2 != 0) return (int)(0); needle = (int)(glyph2); r = (int)(pairValueCount - 1); l = (int)(0); while (l <= r)
									{
										ushort secondGlyph = 0; byte* pairValue; m = (int)((l + r) >> 1); pairValue = pairValueArray + (2 + valueRecordPairSizeInBytes) * m; secondGlyph = (ushort)(ttUSHORT(pairValue)); straw = (int)(secondGlyph); if ((needle) < (straw)) r = (int)(m - 1);
										else if ((needle) > (straw)) l = (int)(m + 1);
										else
										{
											short xAdvance = (short)(ttSHORT(pairValue + 2)); return (int)(xAdvance);
										}
									}
								}
								break;
								case 2:
								{
									ushort valueFormat1 = (ushort)(ttUSHORT(table + 4)); ushort valueFormat2 = (ushort)(ttUSHORT(table + 6)); ushort classDef1Offset = (ushort)(ttUSHORT(table + 8)); ushort classDef2Offset = (ushort)(ttUSHORT(table + 10)); int glyph1class = (int)(stbtt__GetGlyphClass(table + classDef1Offset, (int)(glyph1))); int glyph2class = (int)(stbtt__GetGlyphClass(table + classDef2Offset, (int)(glyph2))); ushort class1Count = (ushort)(ttUSHORT(table + 12)); ushort class2Count = (ushort)(ttUSHORT(table + 14)); if (valueFormat1 != 4) return (int)(0); if (valueFormat2 != 0) return (int)(0); if (((((glyph1class) >= (0)) && ((glyph1class) < (class1Count))) && ((glyph2class) >= (0))) && ((glyph2class) < (class2Count)))
									{
										byte* class1Records = table + 16; byte* class2Records = class1Records + 2 * (glyph1class * class2Count); short xAdvance = (short)(ttSHORT(class2Records + 2 * glyph2class)); return (int)(xAdvance);
									}
								}
								break;
								default:
		...
		{
			int xAdvance = (int)(0);
			if ((info.gpos) != 0) xAdvance += (int)(stbtt__GetGlyphGPOSInfoAdvance(info, (int)(g1), (int)(g2))); else if ((info.kern) != 0) xAdvance += (int)(stbtt__GetGlyphKernInfoAdvance(info, (int)(g1), (int)(g2)));
			return (int)(xAdvance);
		}
		...
		public static byte* stbtt_FindSVGDoc(stbtt_fontinfo info, int gl)
		{
			...
			{
				byte* svg_doc = svg_docs + (12 * i); if (((gl) >= (ttUSHORT(svg_doc))) && (gl <= ttUSHORT(svg_doc + 2))) return svg_doc;
			}
			return null;
		}
		...
		public static int stbtt_GetGlyphSVG(stbtt_fontinfo info, int gl, sbyte** svg)
		{
			byte* data = info.data;
			byte* svg_doc;
			if ((info.svg) == (0)) return (int)(0);
			svg_doc = stbtt_FindSVGDoc(info, (int)(gl));
			if (svg_doc != (null))
			{
				*svg = (sbyte*)(data) + info.svg + ttULONG(svg_doc + 4); return (int)(ttULONG(svg_doc + 8));
			}
			else
			{
				return (int)(0);
		...
		public static void* stbtt__hheap_alloc(stbtt__hheap* hh, ulong size, void* userdata)
		{
			...
			else
			{
				...
				{
					int count = (int)((size) < (32) ? 2000 : (size) < (128) ? 800 : 100); stbtt__hheap_chunk* c = (stbtt__hheap_chunk*)(CRuntime.malloc((ulong)((ulong)sizeof(stbtt__hheap_chunk) + size * (ulong)(count)))); if ((c) == (null)) return (null); c->next = hh->head; hh->head = c; hh->num_remaining_in_head_chunk = (int)(count);
				}
				--hh->num_remaining_in_head_chunk; return (sbyte*)(hh->head) + sizeof(stbtt__hheap_chunk) + size * (ulong)hh->num_remaining_in_head_chunk;
			}
		...
		public static void stbtt__hheap_cleanup(stbtt__hheap* hh, void* userdata)
		{
			...
			while ((c) != null)
			{
				stbtt__hheap_chunk* n = c->next; CRuntime.free(c); c = n;
			}
		}
		...
		public static void stbtt__fill_active_edges_new(float* scanline, float* scanline_fill, int len, stbtt__active_edge* e, float y_top)
		{
			...
			while ((e) != null)
			{
				...
				{
					float x0 = (float)(e->fx); float dx = (float)(e->fdx); float xb = (float)(x0 + dx); float x_top = 0; float x_bottom = 0; float sy0 = 0; float sy1 = 0; float dy = (float)(e->fdy); if ((e->sy) > (y_top))
					{
					...
					if (((((x_top) >= (0)) && ((x_bottom) >= (0))) && ((x_top) < (len))) && ((x_bottom) < (len)))
					{
						...
						{
							float height = 0; int x = (int)(x_top); height = (float)(sy1 - sy0); scanline[x] += (float)(e->direction * (1 - ((x_top - x) + (x_bottom - x)) / 2) * height); scanline_fill[x] += (float)(e->direction * height);
						}
						else
						{
							...
							{
								scanline[x] += (float)(area + step / 2); area += (float)(step);
							}
							y_crossing += (float)(dy * (x2 - (x1 + 1))); scanline[x2] += (float)(area + sign * (1 - ((x2 - x2) + (x_bottom - x2)) / 2) * (sy1 - y_crossing)); scanline_fill[x2] += (float)(sign * (sy1 - sy0));
						}
					}
					else
					{
		...
		public static void stbtt__rasterize_sorted_edges(stbtt__bitmap* result, stbtt__edge* e, int n, int vsubsample, int off_x, int off_y, void* userdata)
		{
			...
			while ((j) < (result->h))
			{
				float scan_y_top = (float)(y + 0.0f); float scan_y_bottom = (float)(y + 1.0f); stbtt__active_edge** step = &active; CRuntime.memset(scanline, (int)(0), (ulong)(result->w * sizeof(float))); CRuntime.memset(scanline2, (int)(0), (ulong)((result->w + 1) * sizeof(float))); while ((*step) != null)
				{
					...
					{
						*step = z->next; z->direction = (float)(0); stbtt__hheap_free(&hh, z);
					}
					else
					{
						step = &((*step)->next);
				...
				if ((active) != null) stbtt__fill_active_edges_new(scanline, scanline2 + 1, (int)(result->w), active, (float)(scan_y_top));
				{
				...
				{
					stbtt__active_edge* z = *step; z->fx += (float)(z->fdx); step = &((*step)->next);
				}
				++y; ++j;
			}
		...
		public static void stbtt__sort_edges_ins_sort(stbtt__edge* p, int n)
		{
			...
			for (i = (int)(1); (i) < (n); ++i)
			{
				...
				{
					stbtt__edge* b = &p[j - 1]; int c = (int)(a->y0 < b->y0 ? 1 : 0); if (c == 0) break; p[j] = (stbtt__edge)(p[j - 1]); --j;
				}
		...
		public static void stbtt__sort_edges_quicksort(stbtt__edge* p, int n)
		{
			while ((n) > (12))
			{
				...
				t = (stbtt__edge)(p[0]); p[0] = (stbtt__edge)(p[m]); p[m] = (stbtt__edge)(t); i = (int)(1); j = (int)(n - 1); for (; ; )
				{
					...
					if ((i) >= (j)) break; t = (stbtt__edge)(p[i]); p[i] = (stbtt__edge)(p[j]); p[j] = (stbtt__edge)(t); ++i; --j;
				}
				if ((j) < (n - i))
				{
		...
		public static void stbtt__rasterize(stbtt__bitmap* result, stbtt__point* pts, int* wcount, int windings, float scale_x, float scale_y, float shift_x, float shift_y, int off_x, int off_y, int invert, void* userdata)
		{
			...
			for (i = (int)(0); (i) < (windings); ++i)
			{
				...
				{
					int a = (int)(k); int b = (int)(j); if ((p[j].y) == (p[k].y)) continue; e[n].invert = (int)(0); if ((((invert) != 0) && ((p[j].y) > (p[k].y))) || ((invert == 0) && ((p[j].y) < (p[k].y))))
					{
			...
			*contour_lengths = (int*)(CRuntime.malloc((ulong)(sizeof(int) * n)));
			...
			for (pass = (int)(0); (pass) < (2); ++pass)
			{
				...
				num_points = (int)(0); n = (int)(-1); for (i = (int)(0); (i) < (num_verts); ++i)
				{
					...
					{
						case STBTT_vmove: if ((n) >= (0)) (*contour_lengths)[n] = (int)(num_points - start); ++n; start = (int)(num_points); x = (float)(vertices[i].x); y = (float)(vertices[i].y); stbtt__add_point(points, (int)(num_points++), (float)(x), (float)(y)); break;
						case STBTT_vline: x = (float)(vertices[i].x); y = (float)(vertices[i].y); stbtt__add_point(points, (int)(num_points++), (float)(x), (float)(y)); break;
						case STBTT_vcurve: stbtt__tesselate_curve(points, &num_points, (float)(x), (float)(y), (float)(vertices[i].cx), (float)(vertices[i].cy), (float)(vertices[i].x), (float)(vertices[i].y), (float)(objspace_flatness_squared), (int)(0)); x = (float)(vertices[i].x); y = (float)(vertices[i].y); break;
						case STBTT_vcubic: stbtt__tesselate_cubic(points, &num_points, (float)(x), (float)(y), (float)(vertices[i].cx), (float)(vertices[i].cy), (float)(vertices[i].cx1), (float)(vertices[i].cy1), (float)(vertices[i].x), (float)(vertices[i].y), (float)(objspace_flatness_squared), (int)(0)); x = (float)(vertices[i].x); y = (float)(vertices[i].y); break;
					}
		...
		public static int stbtt_BakeFontBitmap_internal(byte* data, int offset, float pixel_height, byte* pixels, int pw, int ph, int first_char, int num_chars, stbtt_bakedchar* chardata)
		{
			...
			{
				int advance = 0; int lsb = 0; int x0 = 0; int y0 = 0; int x1 = 0; int y1 = 0; int gw = 0; int gh = 0; int g = (int)(stbtt_FindGlyphIndex(f, (int)(first_char + i))); stbtt_GetGlyphHMetrics(f, (int)(g), &advance, &lsb); stbtt_GetGlyphBitmapBox(f, (int)(g), (float)(scale), (float)(scale), &x0, &y0, &x1, &y1); gw = (int)(x1 - x0); gh = (int)(y1 - y0); if ((x + gw + 1) >= (pw))
				{
			...
			for (j = (int)(0); (j) < (h); ++j)
			{
				int i = 0; uint total = 0; CRuntime.memset(buffer, (int)(0), (ulong)(kernel_width)); total = (uint)(0); switch (kernel_width)
				{
					case 2:
						...
						{
							total += (uint)(pixels[i] - buffer[i & (8 - 1)]); buffer[(i + kernel_width) & (8 - 1)] = (byte)(pixels[i]); pixels[i] = ((byte)(total / 2));
						}
						break;
					case 3:
						for (i = (int)(0); i <= safe_w; ++i)
						{
							total += (uint)(pixels[i] - buffer[i & (8 - 1)]); buffer[(i + kernel_width) & (8 - 1)] = (byte)(pixels[i]); pixels[i] = ((byte)(total / 3));
						}
						break;
					case 4:
						for (i = (int)(0); i <= safe_w; ++i)
						{
							total += (uint)(pixels[i] - buffer[i & (8 - 1)]); buffer[(i + kernel_width) & (8 - 1)] = (byte)(pixels[i]); pixels[i] = ((byte)(total / 4));
						}
						break;
					case 5:
						for (i = (int)(0); i <= safe_w; ++i)
						{
							total += (uint)(pixels[i] - buffer[i & (8 - 1)]); buffer[(i + kernel_width) & (8 - 1)] = (byte)(pixels[i]); pixels[i] = ((byte)(total / 5));
						}
						break;
					default:
						for (i = (int)(0); i <= safe_w; ++i)
						{
							total += (uint)(pixels[i] - buffer[i & (8 - 1)]); buffer[(i + kernel_width) & (8 - 1)] = (byte)(pixels[i]); pixels[i] = ((byte)(total / kernel_width));
						}
						break;
				}
				for (; (i) < (w); ++i)
				{
					total -= (uint)(buffer[i & (8 - 1)]); pixels[i] = ((byte)(total / kernel_width));
				}
			...
			for (j = (int)(0); (j) < (w); ++j)
			{
				int i = 0; uint total = 0; CRuntime.memset(buffer, (int)(0), (ulong)(kernel_width)); total = (uint)(0); switch (kernel_width)
				{
					case 2:
						...
						{
							total += (uint)(pixels[i * stride_in_bytes] - buffer[i & (8 - 1)]); buffer[(i + kernel_width) & (8 - 1)] = (byte)(pixels[i * stride_in_bytes]); pixels[i * stride_in_bytes] = ((byte)(total / 2));
						}
						break;
					case 3:
						for (i = (int)(0); i <= safe_h; ++i)
						{
							total += (uint)(pixels[i * stride_in_bytes] - buffer[i & (8 - 1)]); buffer[(i + kernel_width) & (8 - 1)] = (byte)(pixels[i * stride_in_bytes]); pixels[i * stride_in_bytes] = ((byte)(total / 3));
						}
						break;
					case 4:
						for (i = (int)(0); i <= safe_h; ++i)
						{
							total += (uint)(pixels[i * stride_in_bytes] - buffer[i & (8 - 1)]); buffer[(i + kernel_width) & (8 - 1)] = (byte)(pixels[i * stride_in_bytes]); pixels[i * stride_in_bytes] = ((byte)(total / 4));
						}
						break;
					case 5:
						for (i = (int)(0); i <= safe_h; ++i)
						{
							total += (uint)(pixels[i * stride_in_bytes] - buffer[i & (8 - 1)]); buffer[(i + kernel_width) & (8 - 1)] = (byte)(pixels[i * stride_in_bytes]); pixels[i * stride_in_bytes] = ((byte)(total / 5));
						}
						break;
					default:
						for (i = (int)(0); i <= safe_h; ++i)
						{
							total += (uint)(pixels[i * stride_in_bytes] - buffer[i & (8 - 1)]); buffer[(i + kernel_width) & (8 - 1)] = (byte)(pixels[i * stride_in_bytes]); pixels[i * stride_in_bytes] = ((byte)(total / kernel_width));
						}
						break;
				}
				for (; (i) < (h); ++i)
				{
					total -= (uint)(buffer[i & (8 - 1)]); pixels[i * stride_in_bytes] = ((byte)(total / kernel_width));
				}
				pixels += 1;
			}
		}
		...
		public static int stbtt_PackFontRangesGatherRects(stbtt_pack_context spc, stbtt_fontinfo info, stbtt_pack_range* ranges, int num_ranges, stbrp_rect* rects)
		{
			...
			for (i = (int)(0); (i) < (num_ranges); ++i)
			{
				...
				{
					int x0 = 0; int y0 = 0; int x1 = 0; int y1 = 0; int codepoint = (int)((ranges[i].array_of_unicode_codepoints) == (null) ? ranges[i].first_unicode_codepoint_in_range + j : ranges[i].array_of_unicode_codepoints[j]); int glyph = (int)(stbtt_FindGlyphIndex(info, (int)(codepoint))); if (((glyph) == (0)) && (((spc.skip_missing) != 0) || ((missing_glyph_added) != 0)))
					{
						rects[k].w = (int)(rects[k].h = (int)(0));
					}
					else
					{
						stbtt_GetGlyphBitmapBoxSubpixel(info, (int)(glyph), (float)(scale * spc.h_oversample), (float)(scale * spc.v_oversample), (float)(0), (float)(0), &x0, &y0, &x1, &y1); rects[k].w = ((int)(x1 - x0 + spc.padding + spc.h_oversample - 1)); rects[k].h = ((int)(y1 - y0 + spc.padding + spc.v_oversample - 1)); if ((glyph) == (0)) missing_glyph_added = (int)(1);
					}
					++k;
				}
			}
		...
		{
			int i = 0; int j = 0; int k = 0; int missing_glyph = (int)(-1); int return_value = (int)(1);
			...
			for (i = (int)(0); (i) < (num_ranges); ++i)
			{
				...
				{
					stbrp_rect* r = &rects[k]; if ((((r->was_packed) != 0) && (r->w != 0)) && (r->h != 0))
					{
		...
		{
			int i_ascent = 0; int i_descent = 0; int i_lineGap = 0;
			float scale = 0;
			stbtt_fontinfo info = new stbtt_fontinfo();
		...
		public static byte* stbtt_GetGlyphSDF(stbtt_fontinfo info, float scale, int glyph, int padding, byte onedge_value, float pixel_dist_scale, int* width, int* height, int* xoff, int* yoff)
		{
			...
			{
				int x = 0; int y = 0; int i = 0; int j = 0; float* precompute; stbtt_vertex* verts; int num_verts = (int)(stbtt_GetGlyphShape(info, (int)(glyph), &verts)); data = (byte*)(CRuntime.malloc((ulong)(w * h))); precompute = (float*)(CRuntime.malloc((ulong)(num_verts * sizeof(float)))); for (i = (int)(0), j = (int)(num_verts - 1); (i) < (num_verts); j = (int)(i++))
				{
					if ((verts[i].type) == (STBTT_vline))
					{
				...
				for (y = (int)(iy0); (y) < (iy1); ++y)
				{
					...
					{
						float val = 0; float min_dist = (float)(999999.0f); float sx = (float)((float)(x) + 0.5f); float sy = (float)((float)(y) + 0.5f); float x_gspace = (float)(sx / scale_x); float y_gspace = (float)(sy / scale_y); int winding = (int)(stbtt__compute_crossings_x((float)(x_gspace), (float)(y_gspace), (int)(num_verts), verts)); for (i = (int)(0); (i) < (num_verts); ++i)
						{
							...
							else if ((verts[i].type) == (STBTT_vcurve))
							{
								...
								{
									int num = (int)(0); float ax = (float)(x1 - x0); float ay = (float)(y1 - y0); float bx = (float)(x0 - 2 * x1 + x2); float by = (float)(y0 - 2 * y1 + y2); float mx = (float)(x0 - sx); float my = (float)(y0 - sy); float* res = stackalloc float[3]; float px = 0; float py = 0; float t = 0; float it = 0; float a_inv = (float)(precompute[i]); if ((a_inv) == (0.0))
									{
										...
										{
											float discriminant = (float)(b * b - 4 * a * c); if ((discriminant) < (0)) num = (int)(0);
											else
											{
						...
						if ((winding) == (0)) min_dist = (float)(-min_dist); val = (float)(onedge_value + pixel_dist_scale * min_dist); if ((val) < (0)) val = (float)(0); else if ((val) > (255)) val = (float)(255); data[(y - iy0) * w + (x - ix0)] = ((byte)(val));
					}
				}
				CRuntime.free(precompute); CRuntime.free(verts);
			}
